class ComparerDescription:
    """This class compares the descriptions of the list of
    ArticleCandidates and sends the result
    ...
    def extract(self, item, list_article_candidate):  # pylint: disable=unused-argument
        ...
        # The descriptions of the article candidates
        # and the respective extractors are saved
        ...
        if len(list_newspaper) == 0:
            # If there is no description extracted by newspaper,
            # return the first result of list_description.
