class ComparerAuthor:
    """This class compares the titles of the list of
    ...
    def extract(self, item, list_article_candidate):  # pylint: disable=unused-argument
        ...
        # The authors of the ArticleCandidates and the
        # respective extractors are saved in a tuple in list_author.
        ...
        if len(list_newspaper) == 0:
            # If there is no author extracted by newspaper,
            # return the first result of list_author.
